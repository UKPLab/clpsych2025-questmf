...
def train(model, train_dataloader, t_ckpt, val_dataloader=None, epochs=10, evaluation=False):
    ...
    for epoch_i in range(epochs):
        ...
        if evaluation == True:
            ...
            if(val_loss_ccc > best_val_loss_ccc):
                ...
                torch.save(model.state_dict(), t_ckpt)
...
if __name__ == '__main__':
    ...
    best_lstm_regressor.load_state_dict(torch.load(args.text_checkpoint_path + '-parameters.pt'))

    ...
    for epoch_i in range(epochs):
        ...
        if evaluation == True:
            ...
            if(val_loss_ccc > best_val_loss_ccc):
                ...
                torch.save(model.state_dict(), v_ckpt_path)
...
if __name__ == '__main__':
    ...
    best_lstm_regressor.load_state_dict(torch.load(args.video_checkpoint_path+'-phq'+str(args.question_number)+'-sr-parameters.pt'))

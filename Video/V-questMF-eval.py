...
if __name__ == '__main__':
    ...
    r1.load_state_dict(torch.load(args.video_checkpoint_path + '-phq1-sr-parameters.pt'))
    r2.load_state_dict(torch.load(args.video_checkpoint_path + '-phq2-sr-parameters.pt'))
    r3.load_state_dict(torch.load(args.video_checkpoint_path + '-phq3-sr-parameters.pt'))
    r4.load_state_dict(torch.load(args.video_checkpoint_path + '-phq4-sr-parameters.pt'))
    r5.load_state_dict(torch.load(args.video_checkpoint_path + '-phq5-sr-parameters.pt'))
    r6.load_state_dict(torch.load(args.video_checkpoint_path + '-phq6-sr-parameters.pt'))
    r7.load_state_dict(torch.load(args.video_checkpoint_path + '-phq7-sr-parameters.pt'))
    r8.load_state_dict(torch.load(args.video_checkpoint_path + '-phq8-sr-parameters.pt'))
